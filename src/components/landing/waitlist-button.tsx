  ...
  return (
    <>
      ...
      {open
        ? createPortal(
            <div
              className={`fixed inset-0 z-[100] flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm ${dialogClassName}`}
              onMouseDown={(event) => {
            ...
            >
              ...
              >
                ...
                <p className="mt-5 text-xs leading-5 text-slate-500">
                  Only launch-related MyMuscle updates. You can unsubscribe at
                  any time. See our{" "}
                  <Link
                    href="/privacy"
